...
# -*- coding: utf-8 -*-
#
# extract_OSHB_OT_to_ESFM.py
#
# Script handling extract_OSHB_OT_to_ESFM functions
#
...
class State:
    ...
    # end of extract_OSHB_OT_to_ESFM.__init__
...
# end of extract_OSHB_OT_to_ESFM.main
...
# end of extract_OSHB_OT_to_ESFM.loadSourceMorphemeGlossTable
...
# end of extract_OSHB_OT_to_ESFM.loadSourceWordGlossTable
...
\\mt1 {'Songs/Psalms' if English_book_name=='Psalms' else English_book_name}"""
        ...
        if verse_number != last_verse_number:  # we've started a new verse
            ...
            for gloss_index in get_gloss_word_index_list(this_verse_row_list): # Gets the words in GlossOrder
                ...
                assert '  ' not in verse_text, f"ERROR1: Have double spaces in {verse_id} verse text: '{verse_text}'"
...
# end of extract_OSHB_OT_to_ESFM.export_esfm_literal_English_gloss
...
# end of extract_OSHB_OT_to_ESFM.get_verse_rows
...
# end of extract_OSHB_OT_to_ESFM.check_verse_rows
...
def get_gloss_word_index_list(given_verse_row_list: List[dict]) -> List[int]:
    ...
    # return result_list
# end of extract_OSHB_OT_to_ESFM.get_gloss_word_index_list
...
# end of extract_OSHB_OT_to_ESFM.py
