...
SIMPLE_NOUNS = ( # These are nouns that are likely to match one-to-one from the OET-LV to the OET-RV
    ...
    'camels','camel', 'camp',
        ...
        'cities','city',
        'coats','coat', 'collectors','collector', 'commands','command', 'compassion', 'councils','council', 'courtyards','courtyard', 'courts','court', 'countries','country', 'cows','cow',
    ...
    'hairs','hair', 'handkerchiefs','handkerchief', 'hands','hand', 'happiness', 'hare',
        'heads','head', 'hearts','heart', 'heavens','heaven',
        'hides','hide',
        'homes','home', 'honey', 'hooves','hoof', 'horses','horse', 'hours','hour', 'houses','house',
        'husbands','husband',
    'idols','idol', 'incense', 'ink',
    'jails','jail', 'joy', 'judgements','judgement',
    'kidneys','kidney', 'kings','king', 'kingdoms','kingdom', 'kisses','kiss',
    'lambs','lamb', 'languages','language',
        'leaders','leader', 'leather', 'letters','letter',
        'life', 'lights','light', 'lions','lion', 'lips','lip', 'liver',
    ...
    'names','name', 'nations','nation', 'nets','net', 'news',
        'noises','noise', 'nose',
    ...
    'palms','palm',
        ...
        'places','place',
        'powers','power',
        'prayers','prayer', 'priests','priest', 'prisons','prison', 'promises','promise'
    'rabbit',
        'rivers','river',
        'roads','road', 'robes','robe', 'rocks','rock', 'roofs','roof', 'rooms','room', 'ropes','rope',
        'rulers','ruler',
    'sandals','sandal', 'sashes','sash',
        'scrolls','scroll',
        'sea', 'servants','servant', 'services','service',
        'shame', 'sheep', 'shepherds','shepherd', 'ships','ship', 'shrines','shrine',
    ...
    'tables','table', 'taxes','tax',
        ...
        'theatres','theatre', 'things','thing', 'thrones','throne', 'thumbs','thumb',
        'times','time',
        'toes','toe', 'tombs','tomb', 'tongues','tongue', 'towns','town',
        'trees','tree', 'truth',
        'tunics','tunic', 'turban',
    'vines','vine', 'visions','vision',
    'waists','waist', 'walls','wall', 'waters','water', 'ways','way',
        'weeks','week',
